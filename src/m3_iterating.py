...
def run_test_count_negatives():
    ...
    # Test 6:
    expected = 2
    actual = count_negatives([3,9,-2,-11,6])
    print()
    ...
    # Test 7:
    expected = 4
    actual = count_negatives([-3,-10, 0, -3.14, -5])
    print()
...
def run_test_count_short_ones():
    ...
    # Test 8:
    expected = 1
    seq = [[22.2,2,1,3], [0,0], [2,3,3], [6,6,6]]
    actual = count_short_ones(seq)
    print()
    ...
    # Test 9:
    expected = 2
    seq = [[1,3,5,7], [3,3], [12,18,19], [1]]
    actual = count_short_ones(seq)
    print()
    print('Test 9 expected:', expected)
    print('       actual:  ', actual)
    # -------------------------------------------------------------------------
    # done:  Add your 2 ADDITIONAL test(s) here:
    # -------------------------------------------------------------------------
